...
export default class extends Controller{
    ...
    connect(){
        document.getElementById("modal-wrapper").addEventListener("dblclick", (event) => {
    ...
    closeModal(event){
        const modalPainelClicked = document.getElementById("modal-panel").contains(event.target);
        if (!modalPainelClicked){
            leave(document.getElementById("modal-wrapper"));
            leave(document.getElementById("modal-backdrop"));
            leave(document.getElementById("modal-panel"));         
        }
